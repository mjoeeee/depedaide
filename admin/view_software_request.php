...
<body>
    ...
    <div class="header-card">
            <div class="breadcrumb">
                ...
                <a href="software_request">Go back</a>
                <span class="separator">/</span>
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        <div class="form-group">
            ...
            <input type="hidden" name="request_id" value="<?= htmlspecialchars($result['request_id'] ? $result['request_id'] : '') ?>">
                ...
                <div class="input-group">
                    ...
                    <textarea id="briefDescription" name="brief_desc" col="10" placeholder="Enter brief description"><?= htmlspecialchars($result['brief_desc'] ? $result['brief_desc'] : '') ?></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="input-group">
                               <label for="designSpecifications">Attach Inspo Files</label>
...
document.getElementById('fileInput').addEventListener('change', function(event) {
    ...
    if (file) {
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="input-group">
                    ...
                    <textarea id="additionalInfo" name="add_info" rows="2" col="10" placeholder="Enter additional information"><?= htmlspecialchars($result['add_info'] ? $result['add_info'] : '') ?></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="d-flex justify-content-end gap-2 mt-3">
            ...
            <a href="software_request" class="btn btn-secondary"><i class="fas fa-times"></i> Cancel</a>
        </div>
    </form>
</div>
