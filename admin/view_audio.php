...
<body>
    ...
    <div class="form-container">
        ...
        <input type="hidden" name="request_id" value="<?= htmlspecialchars($result['request_id'] ? $result['request_id'] : '') ?>">
            ...
            <input type="text" id="projectTitle" name="projectTitle" value="<?= htmlspecialchars($result['title'] ? $result['title'] : '') ?>">
        </div>

        <!-- Project Description -->
        <div class="form-group">
            <label for="projectDescription">Project Description</label>
            <textarea id="projectDescription" rows="4" name="projectDescription"><?= htmlspecialchars($result['proj_desc'] ? $result['proj_desc'] : '') ?></textarea>
        </div>
        <script>
    ...
    <div class="form-group" id="style_tone">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="datetime-local" name="projectDeadline" id="projectDeadline" value="<?= htmlspecialchars($result['project_deadline'] ? $result['project_deadline'] : '') ?>">
            </div>
        </div>

        <div class="d-flex justify-content-end gap-2 mt-3">
            <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Update Details</button>
            <a href="audio" class="btn btn-secondary"><i class="fas fa-times"></i> Cancel</a>
        </div>
    </div>
            </form>
