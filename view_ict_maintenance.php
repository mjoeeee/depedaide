...
include 'config.php';
include 'admin/query/view_ict_maintenance.php';
...
<body>
    ...
    <nav class="navbar-custom">
        <a class="navbar-brand" href="#">
            <img src="image/Primary.png" alt="Logo">
        </a>
    </nav>
...
<div class="form-container">
    <h3>ICT Maintenance Request Form</h3>
    ...
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" enctype="multipart/form-data">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="date" name="lastRepairDate" 
                        value="<?= !empty($result['DOPE']) ? date('Y-m-d', strtotime($result['DOPE'])) : '' ?>">
                </td>
            </tr>
            <tr>
                <td>Defects/Complaints:</td>
                <td><textarea name="defects" rows="4" required><?= htmlspecialchars($result['serial_no'] ? $result['serial_no'] : '') ?></textarea></td>
            </tr>
        </table>
